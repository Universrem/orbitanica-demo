...
export const O1_EXAMPLES = [
  { key: 'proton_0_84fm',            value_m: 1.7e-15 }, // Протон 1.7 фемтометра
  { key: 'carbon_atom_140pm',       value_m: 1.4e-10 }, // Атом вуглецю 140 пікометрів
  { key: 'h2_molecule_0_1nm',       value_m: 1e-10   }, // Молекула водню 0.1 нм
  ...
  { key: 'cell_50um',               value_m: 3e-5    }, // Типова клітина 30 мкм
  ...
  { key: 'coin_25mm',               value_m: 0.025   }, // Типова монета 25 мм
...
export const O1_EXAMPLES_UNIVERS_DISTANCE = [
  { key: 'proton_0_84fm', value_m: 0.84e-15 }, // Протон 1.84 фемтометра
  { key: 'h2_molecule_0_1nm',       value_m: 1e-10   }, // Молекула водню 0.1 нм
  { key: 'virus_100nm',             value_m: 1e-7    }, // Типовий вірус 100 нм
  { key: 'bacterium_1um',           value_m: 1e-6    }, // Діаметр бактерії 1 мкм
  { key: 'cell_50um',               value_m: 3e-5    }, // Типова клітина 30 мкм
...
export const O1_EXAMPLES_UNIVERS_MASS = [
  ...
  { key: 'area_10_m2',    value_m: 3.5682482323 },  // 10 м² - 3,5682 м
  { key: 'area_20_m2',    value_m: 5.0462650440 },  // 20 м² - 5,0463 м
  { key: 'area_100_m2',   value_m: 11.2837916710 }, // 100 м² - 11,2838 м
  { key: 'area_1000_m2',  value_m: 35.6824823231 }, // 1000 м² - 35,6825 м
];
...
export const O1_EXAMPLES_GEO_POPULATION = [
  { key: 'pop_area_dense_0_5', value_m: 0.798  }, // Дуже щільний натовп — d≈0,79788456 м (S≈0,5 м²/люд)
  { key: 'pop_area_standing_0_7', value_m: 0.944  }, // Стояче розміщення — d≈0,94406974 м (S≈0,7 м²/люд)
...
export const O1_EXAMPLES_HISTORY = [
  ...
  { key: 'cm_1',                    value_m: 1e-2    }, // 1 сантиметр
  { key: 'cm_10',                   value_m: 0.10    }, // 10 сантиметрів
  { key: 'one_step',                value_m: 0.70    }, // Крок 70 сантиметрів
  { key: 'm_1',                     value_m: 1       }, // 1 метр
  ];
...
export const O1_EXAMPLES_MONEY = [
  { key: 'usd_100_banknote', value_m: 0.1145, },  // 100 доларів США — коло тієї ж площі, що й купюра 156 × 66 мм
];
